                ...
                <form action="{{ route('aspirations.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="topic" class="shadow border rounded w-full py-2 px-3 text-gray-700 @error('topic') border-red-500 @enderror">
                            ...
                            <option value="akademik" {{ old('topic') == 'akademik' ? 'selected' : '' }}>Akademik</option>
                            <option value="fasilitas" {{ old('topic') == 'fasilitas' ? 'selected' : '' }}>Fasilitas</option>
                            <option value="organisasi" {{ old('topic') == 'organisasi' ? 'selected' : '' }}>Organisasi</option>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" rows="6" 
                            ...
                            placeholder="Tuliskan aspirasi Anda secara detail (minimal 20 karakter)">{{ old('content') }}</textarea>
                        @error('content') 
                            <span class="text-red-500 text-xs">{{ $message }}</span> 
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline transition">
                            <i class="fas fa-paper-plane mr-1"></i> Kirim Aspirasi
                        </button>
                    </div>
                </form>
            </div>
